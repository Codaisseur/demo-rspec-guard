...
RSpec.describe JobPostingsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all job_postings as @job_postings" do
      ...
      expect(assigns(:job_postings)).to eq([job_posting])
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created job_posting as @job_posting" do
        post :create, {:job_posting => valid_attributes}, valid_session
        expect(assigns(:job_posting)).to be_a(JobPosting)
        expect(assigns(:job_posting)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved job_posting as @job_posting" do
        post :create, {:job_posting => invalid_attributes}, valid_session
        expect(assigns(:job_posting)).to be_a_new(JobPosting)
      end
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "assigns the job_posting as @job_posting" do
        job_posting = JobPosting.create! valid_attributes
        put :update, {:id => job_posting.to_param, :job_posting => invalid_attributes}, valid_session
        expect(assigns(:job_posting)).to eq(job_posting)
      end
